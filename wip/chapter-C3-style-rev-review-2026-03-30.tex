...
\newcommand{\docversion}{0.4.2.0-alpha.4}
\newcommand{\docbuild}{20260330}
\newcommand{\docstartdate}{05 January 2026}
\newcommand{\docenddate}{20260330}
\newcommand{\chapterscompletedof}{3/4}
...
% File Name: chapter-C3-style-rev-review-2026-03-30.tex
% Issue: #44
% WIP Naming Convention: 2026-03-24
% Target Chapter: C3 (DMS -- Display Management Switch)
% WIP Status: review
% (alpha = parallel pre-release flow only — see wip-naming.md §3.1)
% Created: 2026-03-30
% Last Modified: 2026-03-30
% Integration Status: NOT YET INTEGRATED | INTEGRATION TARGET: alpha.4
%
% Narrative Completion: 0%
% Table Fill Status: N/A (style revision — no new tables)
%
% Notes:
% - Style revision pass for C3 (DMS). Start: 2026-03-30.
% - Scope: full chapter (intro, §3.1–§3.4), hotastable cells included.
% - Source: guide.tex (C3 as integrated in v0.4.1.1).
% - Criteria: misc/STYLE-GUIDE.md — remove AI-speak, direct technical voice.
...
The Display Management Switch (DMS) is a four-way hat switch on the side-stick controller. It selects the Sensor of Interest (SOI) — the display or sensor that currently receives HOTAS inputs — and cycles the format pages on each Multifunction Display (MFD).
