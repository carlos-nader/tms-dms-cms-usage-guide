...
%
% Narrative Completion: ~90% (all sections complete except §2.1.3 TGP paragraph)
...
% - #47 Task 2 (TGP paragraph into §2.1.3): pending
...
Default sensor, display, and weapon options are configured by the active Master Mode. HOTAS switch inputs are interpreted within that configuration. These defaults are programmable via the Data Transfer Cartridge (DTC) or adjustable manually in-flight. For complete Master Mode details, see \dashref{2.1.1.2.1}.
