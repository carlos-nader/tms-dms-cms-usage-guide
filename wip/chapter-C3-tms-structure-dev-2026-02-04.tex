...
%--------------------------------------------------------------------------
% CHAPTER 3 INTRODUCTION (Narrative)
%--------------------------------------------------------------------------
...
\begin{enumerate}
    \item \textbf{General TMS concept and timing} (Section~\ref{sec:C3-S1})
    \item \textbf{TMS with SA displays} (HSD, FCR non-tracking modes) (Section~\ref{sec:C3-S2})
    \item \textbf{TMS in Air-to-Air} (FCR tracking, ACM, TWS, IFF) (Section~\ref{sec:C3-S3})
    \item \textbf{TMS in Air-to-Ground} (FCR GM/GMT/SEA, TGP, MARK) (Section~\ref{sec:C3-S4})
    \item \textbf{TMS in weapon employment} (AGM-65, HARM, DTOS, IAM-VIS, CCIP/CCRP) (Section~\ref{sec:C3-S5})
    \item \textbf{Block/variant notes} (Section~\ref{sec:C3-S6})
\end{enumerate}
...
%--------------------------------------------------------------------------
% SUBSECTION 3.1.1: PHYSICAL LOCATION AND ACTUATION
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.1.2: DIRECTIONAL FUNCTIONS (GENERAL OVERVIEW)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.1.3: TMS AND SENSOR OF INTEREST (SOI)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.1.4: TMS TIMING AND PRESS DURATION LOGIC
%--------------------------------------------------------------------------
...
\newpage
%--------------------------------------------------------------------------
% SECTION 3.2: TMS AND SITUATIONAL AWARENESS DISPLAYS
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.2.1: TMS WITH HSD AS SOI
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S2-HSD} for detailed HSD TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.2.2: TMS WITH FCR IN SEARCH MODES (PRE-DESIGNATION)
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S2-FCR-search} for FCR search mode TMS actions.

%--------------------------------------------------------------------------
% PLACEHOLDER: TABLE 3.2.1 — TMS Actions with HSD as SOI
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% PLACEHOLDER: TABLE 3.2.2 — TMS Actions in FCR Search Modes
%--------------------------------------------------------------------------
...
% [Content to be developed: Mode | Dir. | Act. | Function | Effect/Nuance | Dash34 | Train.]
% \end{hotastable}
% \label{tab:C3-S2-FCR-search}
% \end{table}

\newpage
%--------------------------------------------------------------------------
% SECTION 3.3: TMS IN AIR-TO-AIR
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.3.1: TMS IN SAM (SITUATION AWARENESS MODE)
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S3-SAM} for detailed SAM TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.3.2: TMS IN STT (SINGLE TARGET TRACK)
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S3-STT} for STT TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.3.3: TMS IN TWS (TRACK-WHILE-SCAN)
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S3-TWS} for TWS TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.3.4: TMS IN ACM (AIR COMBAT MANEUVERING) MODES
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S3-ACM} for ACM TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.3.5: TMS AND IFF INTERROGATION
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S3-IFF} for IFF TMS actions.

%--------------------------------------------------------------------------
% PLACEHOLDER: TABLES FOR SECTION 3.3
%--------------------------------------------------------------------------
...
\newpage
%--------------------------------------------------------------------------
% SECTION 3.4: TMS IN AIR-TO-GROUND (SENSORS AND TARGETING)
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.4.1: TMS WITH FCR IN A-G RADAR MODES (GM/GMT/SEA)
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S4-FCR-AG} for FCR A-G TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.4.2: TMS WITH TARGETING POD (TGP) AS SOI
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S4-TGP} for TGP TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.4.3: TMS WITH HUD/HMCS MARK FUNCTION
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S4-MARK} for MARK TMS actions.

%--------------------------------------------------------------------------
% PLACEHOLDER: TABLES FOR SECTION 3.4
%--------------------------------------------------------------------------
...
% \end{hotastable}
% \label{tab:C3-S4-MARK}
% \end{table}

\newpage
%--------------------------------------------------------------------------
% SECTION 3.5: TMS IN WEAPON EMPLOYMENT
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% SUBSECTION 3.5.1: TMS IN AGM-65 MAVERICK EMPLOYMENT
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S5-AGM65} for AGM-65 TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.5.2: TMS IN DTOS (DIVE TOSS) DELIVERIES
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S5-DTOS} for DTOS TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.5.3: TMS IN IAM-VIS (JSOW/JDAM VISUAL)
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S5-IAMVIS} for IAM-VIS TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.5.4: TMS IN CCIP/CCRP DELIVERIES
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S5-CCIP-CCRP} for CCIP/CCRP TMS actions.

%--------------------------------------------------------------------------
% SUBSECTION 3.5.5: TMS IN HARM EMPLOYMENT
%--------------------------------------------------------------------------
...
See Table~\ref{tab:C3-S5-HARM} for HARM TMS actions.

%--------------------------------------------------------------------------
% PLACEHOLDER: TABLES FOR SECTION 3.5
%--------------------------------------------------------------------------
...
% \end{hotastable}
% \label{tab:C3-S5-HARM}
% \end{table}

\newpage
%--------------------------------------------------------------------------
% SECTION 3.6: TMS -- BLOCK AND VARIANT NOTES
%--------------------------------------------------------------------------
