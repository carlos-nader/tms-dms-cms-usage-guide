...
%
% Notes:
% - Style revision pass in progress.
% - Session 2026-03-17: sections revised: Intro C1, §1.1, §1.2, §1.3.1.
% - Session 2026-03-19: structural review applied (see issue #46 comment 2026-03-19):
...
%     · §1.4.4 Disclaimer condensed: affiliation denial removed (already in chapter opening)
% - Sections pending style revision: §1.3.2, §1.3.3 (placeholder), §1.3.4, §1.4.2.
% - Pending tasks (issue #46):
%     (1) Add §1.3.3 Typographic conventions (relocated from §1.3.4 per structural review 2026-03-19)
...
% [PLACEHOLDER — content to be added per issue #46, Task 1]

%--------------------------------------------------------------------------
% SECTION 1.3.4: REFERENCE CONVENTIONS
%--------------------------------------------------------------------------
