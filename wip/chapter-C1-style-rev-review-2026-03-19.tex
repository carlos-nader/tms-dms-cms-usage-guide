...
% File Name: chapter-C1-style-rev-review-2026-03-19.tex
% Issue: #46
...
% Style Revision: COMPLETE (pending author final read-through before integration)
% Table Fill Status: N/A (C1 has no hotastable environments)
%
% Notes:
% - Session 2026-03-17: sections revised: Intro C1, §1.1, §1.2, §1.3.1.
% - Session 2026-03-19: structural review + full style revision pass completed:
%     · §1.3.3 / §1.3.4 reordered: Typographic conventions → §1.3.3; Reference conventions → §1.3.4
%     · §1.3.4 eliminated (content covered by §1.2 and §1.3.2)
%     · §1.3.3 Typographic conventions added (issue #46, Task 1)
%     · §1.4 renamed: "Version, authorship, and AI assistance" → "About this document"
%     · §1.4.3 + §1.4.4 merged: "License and canonical source" (§1.4.3); Disclaimer renumbered → §1.4.4
%     · §1.4.4 Disclaimer condensed
%     · §1.4.2 revised: GitHub Copilot Pro added; AI roles clarified (issue #46, Task 2)
% - WIP Status: review — awaiting author final read-through before integration.
...
\begin{itemize}
	\item \textbf{Bold} identifies the three HOTAS switches covered by this guide and their directions when referenced in prose: \textbf{TMS}, \textbf{DMS}, \textbf{CMS}, \textbf{TMS Up}, \textbf{CMS Down} and \textbf{DMS Left}.
