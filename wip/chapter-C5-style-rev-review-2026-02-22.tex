...
%============================================================================
% File Name: chapter-C5-style-rev-review-2026-02-22.tex
...
% - Session 2026-02-22: §5.2.2 (ECM) e §5.2.3 (Consent and Constraints) completos.
%   Títulos revisados. Prosa e tabelas revisadas (style violations corrected:
%   PROHIBITED ×1, PASSIVE-MISUSE ×2, CLOSING ×1, FORMAT-ITAL ×2).
%   §5.2.4 (Operational Notes) completo: 5 parágrafos aprovados, PASSIVE-MISUSE ×4
%   corrigidos. Frase de encadeamento adicionada em §5.2.2 (RF switch / landing gear).
% - Session 2026-02-23: §5.3 completo. Dash-34 validation pass executado (C5 inteiro).
%   Corrections applied: Program 5 mention added after §5.2.1.1 hotastable
%   (\dashref{2.7.2.2}); §5.2.4 RF Switch Override rewritten (PASSIVE-MISUSE,
%   "both pod and IDIAS" imprecision corrected → "the ECM system"); §5.2.2.1
%   "Both systems" → "The ECM system"; §5.2.1.2 typo (double full stop) corrected.
%   §5.3.1.3 eliminated (scope note absorbed into §5.3.1 opening paragraph).
%   ECM Configuration Summary Table added to §5.3.
% - TODO: RWR introduced for the first time at §5.2.1.2. Consider conceptual
%   introduction in C2 (HOTAS Fundamentals).
% - TODO: BYP and STBY modes not covered in §5.2.1. See sub-issue #48 (linked
...
% - TODO: "three operational modes" in §5.2.1 opening will require update when
...
Flare-only program. PRGM knob position has no effect. Independent of threat sensing.
& 2.7.2.2 & 19 \\
\end{hotastable}

Program 5 is activated via the slap switch, independent of CMS. See \dashref{2.7.2.2}.
...
Pilot consent is given \textit{once} by pressing \textbf{CMS Down}; dispensing continues until \textbf{CMS Right} is pressed or expendables are exhausted.
...
Removes CMDS consent and places the ALE-47 in Standby. Automatic dispensing halts immediately. Pilot must re-issue CMS Down to resume AUTO operation.
& 2.7.2.1 & 18, 28 \\
\end{hotastable}
...
In Semi-Automatic (SEMI) mode, the ALE-47 CMDS dispenses \textit{one program} per RWR-detected threat, with pilot consent required for \textit{each event}.
