...
%
% Narrative Completion: ~35% (chapter opener + §2.1 complete; §2.2, §2.3 pending)
% Table Fill Status: N/A
%
% Notes:
% - Style revision pass for C2 — milestone v0.4.2.0, parent #44
% - Structural decisions (pre-pass): §2.1 → "Sensor of Interest (SOI)" DONE;
%   §2.1.1 → "SOI Fundamentals" DONE; §2.2 collapse to plain text TBD during review;
%   §2.3.1–2.3.3 "— Overview" suffix removed — pending
