...
In Semi-Automatic (SEMI) mode, the CMDS control unit displays \texttt{DISPENSE RDY} and sounds a \texttt{COUNTER} voice message every time a threat is detected. For each \texttt{COUNTER} message, a \textbf{CMS Down} press grants consent and the ALE-47 CMDS then dispenses \textit{one selected program}.
