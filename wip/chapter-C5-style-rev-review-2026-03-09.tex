...
The ALE-47 CMDS operates in five modes selected via the CMDS CCU MODE knob: Manual (MAN), Automatic (AUTO), Semi-Automatic (SEMI), Bypass (BYP), and Standby (STBY). The chaff and flare dispensing program executed in MAN, AUTO, and SEMI modes --- Programs 1--4 --- is selected via the PRGM knob on the CMDS panel. The PRGM knob has no effect in BYP or STBY.
