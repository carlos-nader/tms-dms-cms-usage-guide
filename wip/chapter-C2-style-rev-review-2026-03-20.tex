...
%
% Notes:
% - Addresses #47 (C2 CMS defensive system orientation) under parent #44
% - Task 1: Add \subsection{CMS — Defensive System Overview} covering CMDS
%   MAN/AUTO/SEMI modes, ECM External Pod vs. IDIAS, and RWR role
%   Validate against Dash-34 §2.7.1, §2.7.2.1, §2.7.4
% - Task 2: Incorporate and style-revise TGP paragraph into §2.1.3
%   (from deprecated section-C2-S1-S3-soi-context-dependency-final-2026-02-15.tex)
%   Cross-ref to sec:C4-S3-S6 will produce LaTeX warning until C4:S3 is written — expected
