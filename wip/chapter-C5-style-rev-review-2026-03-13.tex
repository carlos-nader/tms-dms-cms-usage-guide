...
%============================================================================
% File Name: chapter-C5-style-rev-review-2026-03-12.tex
...
% - Author final read-through in progress (sessions: 2026-03-09, 2026-03-12, 2026-03-13).
%   Changes: §5.1 Dash-34 ref updated; §5.2.1 terminology standardized (executes);
%   §5.2.1.3 SEMI mode prose restructured; Program 6 cells standardized (is dispensed).
%   Session 2026-03-13: §5.2.2 opening converted to \itemize (external/internal configs),
...
After setting the operation mode, \textbf{CMS Down} grants consent for ECM pod transmission and the ECM Enable light on the left miscellaneous panel illuminates.
...
For IDIAS to operate, the power switch must be in ON. Then, with the XMTR switch in OPER, \textbf{CMS Left} cycles the ECM operation mode.
