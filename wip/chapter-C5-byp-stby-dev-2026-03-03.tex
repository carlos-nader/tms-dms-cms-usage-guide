...
%============================================================================
% File Name: chapter-C5-byp-stby-dev-2026-03-03.tex
...
%
% Notes:
% - This file contains ONLY the sections modified by issue #48 (BYP/STBY).
% - Sections NOT present here remain as-is in chapter-C5-style-rev-review-2026-03-03.tex.
% - Modified sections: §5.2 intro (line 494 edit), §5.2.1 opening (line 516 edit),
%   §5.2.1.1–§5.2.1.3 (copied verbatim), §5.2.1.4 (new), §5.2.3 (intro addition),
%   §5.2.4 (State Tracking addition).
% - Integration: replace corresponding sections in C5 WIP with content from this file.
% - Cross-reference: Issue #48 (BYP/STBY addition to §5.2.1).
