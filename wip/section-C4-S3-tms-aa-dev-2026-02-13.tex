...
% File Name: section-C4-S3-tms-aa-dev-2026-02-13.tex
% WIP Naming Convention: v1.4
% Target Chapter: C4 (TMS)
% Target Section: S3 (A-A Mode)
...
% Table Fill Status: 0%
%
% Notes: only markdowns for future content
...
This section documents TMS behavior in air-to-air tracking and engagement contexts: FCR tracking modes (SAM, STT, TWS), Air Combat Maneuvering (ACM), Targeting Pod A-A mode, and IFF interrogation.

\textbf{Note:} TMS with HSD for datalink target management (PDLT designation) is covered in \secref{sec:C4-S2-S1}. While PDLT is an A-A function, HSD is primarily a situational awareness display rather than a direct targeting sensor. 
For HSD PDLT procedures in A-A contexts, see \secref{sec:C4-S2-S1} and \tabref{tab:hsd-tms}.
