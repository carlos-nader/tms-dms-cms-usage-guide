...
%============================================================================
% File Name: chapter-C5-style-rev-review-2026-03-14.tex
...
%
% WIP Status: review → final (pending rename)
% Created: 2026-02-19
...
% - Author final read-through complete (sessions: 2026-03-09, 2026-03-12, 2026-03-13,
%   2026-03-14). All changes author-approved. File ready for → final.
% - C5 style revision complete (2026-03-06). All sections §5.1–§5.3 approved.
%   Full session history in issue #44 comments.
% - Read-through change log:
%   Sessions 2026-03-09/12/13: §5.1 Dash-34 ref updated; §5.2.1 terminology standardized
%   (executes); §5.2.1.3 SEMI mode prose restructured; Program 6 cells standardized
%   (is dispensed). §5.2.2 opening converted to \itemize (external/internal configs),
%   \textit{} removed from list items; §5.2.2.1 opening rewritten (power switch OPR
%   precondition + XMIT switch intro); §5.2.2.1 post-itemize sentence updated (sequential
%   link added); §5.2.2.2 opening rewritten (power switch ON precondition + XMTR/OPER
%   sequence); §5.2.2.2 "active mode" → "active operation mode". Validated against
%   Dash-34 §2.7.4.1.1, §2.7.4.1.2, §2.7.4.1.3, §2.7.4.2.5.
%   §5.1 \itemize revised: ECM item rewritten (function added: "the radar-jamming system");
%   ECM configuration detail moved to dedicated sentence after list. Validated against
%   Dash-34 §2.7.1, §2.7.4.2.1.
%   Session 2026-03-14: §5.2.2.2 "the power switch" → "its power switch" (parallelism
%   with §5.2.2.1); §5.2.3 opening revised (redundancy removed, \textit{external} added,
%   "CMDS AUTO and SEMI modes" standardized); §5.2.3 new paragraph added (joint consent
%   does not apply to IDIAS-equipped aircraft); §5.2.4 State Tracking revised ("CMDS AUTO
%   and SEMI modes", \textit{not cleared} added, last sentence restructured); §5.2.4
%   "IDIAS vs. External ECM Pod" paragraph removed (content absorbed into §5.2.3).
