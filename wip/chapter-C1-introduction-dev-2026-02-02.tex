...
% File Name: chapter-C1-introduction-dev-2026-02-02.tex
...
The guide assumes knowledge of basic F-16 operation and familiarity with master modes (NAV, A-A, A-G, DGFT). It does not replace the Dash-34 or Training Manual; rather, it complements them by organizing TMS, DMS, and CMS behavior into searchable tables with cross-references back to official sources and practical training missions where each behavior can be practiced.
