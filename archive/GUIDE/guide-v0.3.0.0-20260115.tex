...
% --------------------------------------------------------------------------
\newcommand{\docversion}{0.3.0.0} % MINOR bump (C4 S1 e S2.1 integrados)
...
\newcommand{\tablesfilledpct}{Chapter 5 and Chapter 4.2.1}
\newcommand{\fulldocversion}{\docversion+\docbuild} % C1, C5 and C4 (partially)
...
% CHAPTER 5: CMS
% --------------------------------------------------------------------------
\section{CMS -- Countermeasures Management Switch}\label{sec:C5}
