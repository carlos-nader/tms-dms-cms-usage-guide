...
The Sensor of Interest (SOI) is the display or sensor that currently receives HOTAS cursor slew commands and, where applicable, TMS actions. \textbf{At any moment, only one display can be the SOI}. Visually, The currently active SOI is easily recognized:
