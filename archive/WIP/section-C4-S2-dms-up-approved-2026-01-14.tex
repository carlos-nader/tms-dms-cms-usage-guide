...
% ============================================================================
% This WIP file follows template-wip structure and is intended
...
% --------------------------------------------------------------------------
% TABLES AND MACROS (hotastable per Briefing)
% --------------------------------------------------------------------------
\usepackage{booktabs}
\usepackage{array}
...
% This table remains the core reference for DMS Up across master modes (see briefing).
