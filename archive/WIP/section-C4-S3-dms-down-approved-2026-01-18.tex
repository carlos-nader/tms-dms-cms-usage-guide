...
% ============================================================================
% File Name: section-C4-S3-dms-down-approved-2026-01-19.tex
...
Therefore, \textbf{DMS Down and DMS Up} work in tandem in A-G VIS: DMS Down allows the pilot to 
...
in these modes (see Sections~\ref{sec:C4-S1-S1} and \ref{sec:C4-S1-S3}). 
...
In A-A contexts, this is \textbf{operationally essential}: the pilot uses DMS Down to shift SOI focus between onde MFD and the ohter so he can access and have direct control over whichever format is being actually displayed: FCR for track management 
