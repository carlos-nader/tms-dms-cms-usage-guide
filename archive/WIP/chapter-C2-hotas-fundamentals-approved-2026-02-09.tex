...
\newcommand{\docversion}{v0.4.0.0}
\newcommand{\docbuild}{WIP Chapter 2}
\newcommand{\docstartdate}{06 February 2026}
\newcommand{\docenddate}{06 February 2026}
\newcommand{\chapterscompletedof}{C2}
...
% File Name: chapter-C2-hotas-fundamentals-approved-2026-02-09.tex
...
% Integration Status: INTEGRATED INTO v0.4.0.0 (MINOR bump)
%
