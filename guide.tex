...
\textbf{Disclaimer:} This is an unofficial, community-made document not affiliated with, endorsed by, or affiliated with Benchmark Sims, MicroProse, any military organization, or any aircraft or weapons manufacturer. All technical content is paraphrased in original words from official BMS documentation. No copyrighted material is reproduced directly. The guide is provided ``as-is'' for educational and simulation training purposes only. \textbf{Copyright \& Sharing:} This guide may be freely copied, printed, translated, and shared within the Falcon BMS community for non-commercial use. Derivative works and contributions are encouraged, provided that proper credit is given to the original author and no derivative version claims official status.
