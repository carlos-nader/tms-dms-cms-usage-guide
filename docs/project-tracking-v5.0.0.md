...
| **Status** | **review** (C4:§4.3 intro, C4:§4.3.5 intro, C4:§4.3.5.1, C4:§4.3.5.2), dev (remaining subsections) |
...
| **Next step** | Continue development: finalize §4.3.5 subsections S3–S5 (Emergency, Constraints, AIFF Availability) prose → finalize §4.3 subsections S1–S4, S6 prose → populate 6 hotastable tables → review → final → approved |
...
- 🟡 Pending: §4.3.5.3 (Emergency Mode), §4.3.5.4 (Constraints), §4.3.5.5 (AIFF Availability) narrative
