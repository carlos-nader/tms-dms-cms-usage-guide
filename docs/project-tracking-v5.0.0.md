...
**Last Updated:** 2026-01-13, 02:38 AM -03  
...
Current state as of 2026-01-13, 02:38 AM -03:
...
- **Chapters with structure scaffolded:** 4/7
  - Chapters 2 (HOTAS Fundamentals), 3 (TMS), 4 (DMS), plus outlines for 6 (Training References) and 7 (HOTAS Visual Reference)
- **Tables filled:** 1 major HOTAS table (CMS, integrated Sections 5.2--5.3); remaining tables: 0 (pending WIP development)
...
|---|---|---|---|---|
| v0.3.0.0 | Chapter 4 -- DMS (Sections 4.1--4.3) | 0 | IN PROGRESS | C4-S1 WIP under review (section-C4-S1-concept-soi-review-2026-01-12.tex). C4-S2, C4-S3 planned. MINOR bump. |
...
### 4.2 Active WIP Snapshot (as of 2026-01-13, 02:38 AM -03)
...
| 13 | 2026-01-13 | v0.2.4.0 (unchanged) | v5.0.0 | **C4-S1 Manual Integration + Research Validation:** (1) C4-S1 manually integrated by author with new Table "Valid SOI Displays by Master Mode" (6 rows: NAV, A-A, A-G PRE, A-G VIS, DGFT, MSL OVRD). Heading uses official HOTAS pattern (rowcolor headerblue + textcolor white). File renamed to section-C4-S1-concept-soi-review-2026-01-12.tex; status: dev → **review** (NOT yet final; awaiting formal approval before guide integration). File location: WIP/section-C4-S1-concept-soi-review-2026-01-12.tex. (2) Deep technical research: HUD/HMCS SOI constraints in A-A/DGFT/MSL OVRD validated against Dash-34 Sections 2.1.1.2.3, 2.5.5.1, 4.3.2.4. HMCS cueing independence from SOI status confirmed. AIM-9 BORE/SLAVE hierarchy documented. (3) LaTeX formatting guidance: tabularx (official pattern), booktabs, array packages verified against guide.tex preamble. (4) Support documentation: 8 files generated covering HUD/HMCS/AIM-9 aprofundamento, LaTeX options, integration validation. Next: Begin C4-S2 (MFDS Format Cycling, DMS Left/Right axis). |
...
|---|---|---|---|
| **v0.3.0.0** | Chapter 4 -- DMS (Sections 4.1 in review, 4.2--4.3 planned) | IN PROGRESS | C4-S1 WIP under review. Includes new Table "Valid SOI Displays by Master Mode". C4-S2 (MFDS Format Cycling, Left/Right axis) and C4-S3 (Context & Weapon Management) planned. MINOR bump when all 3 sections integrated. |
...
| guide-v0.2.4.0-20260111.tex | **active** | main guide | Current baseline snapshot. Use as base for v0.3.0.0 prep (C4-S1 integration pending). |
...
|---|---|---|---|---|
| WIP/section-C4-S1-concept-soi-review-2026-01-12.tex | -- | section | **review** | DMS Chapter 4 Section 1 Concept and SOI. Manually integrated by author with Table "Valid SOI Displays by Master Mode" (6 rows). Status: dev → **review** (NOT yet final; pending formal approval before guide-v0.3.0.0 integration). File remains in WIP/ pending author's formal review cycle completion. |
...
| docs/PROJECT-TRACKING-v5.0.0.md | 5.0.0 | tracking | active | This document -- unified tracking with Git/GitHub integration. Updated Session 13. |
