...
|-------------------------------|:-------:|---------------------------------------|------------------|
| VERSION-SYSTEM-v4.2.1         |  v4.2.1 | Versioning rules for `guide-v*`       | Defines 0.x.x.x vs x.y.z regimes; MAJOR/MINOR/PATCH/SUBPATCH semantics; build date rules. Updated Session 9: refs → v1.4; BRIEFING-v0.2.0.1 relation documented. |
...
| BRIEFING-v0.2.0.1             | v0.2.0.1| Content and layout brief + template   | Scope, style, layout standard (Geometry Option D, `hotastable` 15.6 cm, `\\arraystretch=1.25`), high-level roadmap. **NEW Section 11:** Complete template specification per BRIEFING-v0.2.0.1 Section 11. |
...
> Note: All `guide-v0.1.x.x` and `guide-v0.2.0.1/0.2.1.0` files are preserved under version control (and/or ARCHIVE) for rollback and traceability.

### 3.2 Planned Near-Term Versions

| Target Version | Expected Area                        | Phase | Status  | Notes |
|----------------|--------------------------------------|:-----:|---------|-------|
| v0.2.3.0       | Chapter 5 — Sections 5.2 & 5.3       |   0   | 🔄 Planned | Integrate CMS Actuation (5.2) and Block/Variant notes (5.3) once WIP is promoted to `final`. Both WIP files created in Session 9 using BRIEFING-v0.2.0.1 Section 11 template spec. Still within 0.2.x.x line (no new chapter yet). |
...
|---------------------------------------------------------------------------|:------:|:-------:|:---:|------------|
| `WIP/section-C5-S2-cms-actuation-hotas-tables-review-2026-01-09.tex`     | review |  C5-S2  | ✅ BRIEFING-v0.2.0.1 Section 11 compliant | Validate LaTeX compilation; complete narrative/TBDs; promote to `final` and integrate into guide (v0.2.3.0 target). |
| `WIP/section-C5-S3-blocks-and-variants-review-2026-01-09.tex`            | review |  C5-S3  | ✅ BRIEFING-v0.2.0.1 Section 11 compliant | Validate content accuracy; promote to `final` and integrate (also in v0.2.3.0 line). |
...
| 2026-01-09 | `TEMPLATES/template-wip-V1.0.tex` (NEW)                                         | — (governance)               | template | **Canonical WIP template** established per BRIEFING-v0.2.0.1 Section 11; preamble/metadata/hotastable locked; independent versioning (V1.0). All future WIP files MUST use this template. |
| 2026-01-09 | `BRIEFING-v0.1.4.1 → BRIEFING-v0.2.0.1`                                        | governance (MINOR)           | briefing | **Section 11 added** (8 subsections, ~2,500 words): Complete template specification, metadata block format, hotastable environment, section skeleton, integration workflow, template versioning & maintenance. |
...
| 2026-01-09 | `VERSION-SYSTEM-v4.2 → VERSION-SYSTEM-v4.2.1`                                  | governance (PATCH)           | versioning | References updated to WIP-FILE-NAMING-v1.4; BRIEFING-v0.2.0.1 Section 11 relation documented; 3-way integration clarified (BRIEFING + WIP-NAMING + VERSION-SYSTEM). |
| 2026-01-09 | `section-C5-S2-cms-actuation-hotas-tables-review-2026-01-09.tex` (NEW WIP)       | — (pending v0.2.3.0)        | sections | CMS Actuation (S2) WIP file created using BRIEFING-v0.2.0.1 Section 11 template. LaTeX syntax corrected (custom column types). Ready for human review and promotion to `final`. |
| 2026-01-09 | `section-C5-S3-blocks-and-variants-review-2026-01-09.tex` (NEW WIP)              | — (pending v0.2.3.0)        | sections | CMS Blocks/Variants (S3) WIP file created using BRIEFING-v0.2.0.1 Section 11 template. LaTeX syntax corrected (custom column types). Ready for human review and promotion to `final`. |
...
1. **✅ CMS Chapter 5 Content Consolidation & Template Adoption (Session 9 — COMPLETED)**  
   - ✅ **Established BRIEFING-v0.2.0.1 Section 11** with complete template specification (8 subsections, ~2,500 words).  
   ...
   - **FUTURE:** All new WIP files MUST follow BRIEFING-v0.2.0.1 Section 11 template specification.
...
|---------------------------------------------------------------------------|:--------:|---------|:---:|-----------|
| `ARCHIVE/section-C5-S1-concept-and-interactions-cmds-ecm-rwr-approved-2026-01-08.tex` | approved | section | N/A (pre-template) | Integrated into guide v0.2.0.1. Keep archived as reference. |
| `WIP/section-C5-S2-cms-actuation-hotas-tables-review-2026-01-09.tex`     | review   | section | ✅ BRIEFING-v0.2.0.1 Section 11 | Validate LaTeX compilation; complete narrative/TBDs; promote to `final`; integrate into v0.2.3.0. |
| `WIP/section-C5-S3-blocks-and-variants-review-2026-01-09.tex`            | review   | section | ✅ BRIEFING-v0.2.0.1 Section 11 | Validate content accuracy; promote to `final`; integrate into v0.2.3.0. |
